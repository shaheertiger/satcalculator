    ...
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
      ...
      <div className="space-y-3 mb-4">
        {attempts.map((attempt) => (
          <div key={attempt.id} className="flex items-center gap-3 bg-slate-50 rounded-xl p-3 border border-slate-100">
            <input
              type="text"
              value={attempt.label}
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-100">
        <div className="text-center mb-3">
          ...
          <div className="text-5xl font-black text-slate-900 tracking-tight font-heading mt-1">{superscore}</div>
        </div>
        <div className="grid grid-cols-2 gap-4 mb-3">
          <div className="text-center">
            <div className="text-xs text-blue-600 font-semibold uppercase">Best R&W</div>
            <div className="text-xl font-bold text-slate-800">{bestRW}</div>
          </div>
          <div className="text-center">
            <div className="text-xs text-emerald-600 font-semibold uppercase">Best Math</div>
            <div className="text-xl font-bold text-slate-800">{bestMath}</div>
          </div>
        </div>
        {improvement > 0 && (
